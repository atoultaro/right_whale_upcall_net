...
if args.test is False:
    ...
    SoundPath = os.path.join(DATA_DIR, r'__large_test_dataset/__sound')
else:
    SoundPath = os.path.join(DATA_DIR, r'__large_test_dataset/__sound_short') ## TEST
...
result_path = os.path.join(config.TRAIN_RESULT_PATH, '__full_data_large')
